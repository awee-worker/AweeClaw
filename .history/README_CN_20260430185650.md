...
AweeClaw 不仅仅是一个编辑器，它是你的**智能编程伴侣**。它复刻并超越了传统 IDE 的体验，融合了 Cyberpunk 玻璃拟态设计风格，内置强大的 AI Agent，支持从代码生成到文件操作的全流程自动化。

<!-- 主界面演示 -->
<div align="center">
  <img src="images/main.gif" alt="AweeClaw 主界面演示" width="820" />
</div>

---
### 🏆 荣誉奖杯：鸣谢墙

> "AweeClaw 的每一行代码，都有大家投喂的能量注入！" ⚡️

感谢以下慷慨的支持者，你们提供的咖啡、奶茶和能量饮料是 AweeClaw 进化最强劲的动力！
...
| 扫码加入微信群 | QQ群号: `1076926858` | 微信号: `awee_worker` |

> 💡 如有问题或建议，也可以直接在 [Gitee Issues](https://gitee.com/jweelee/aweeclaw.git/issues) 或[Github Issues](https://github.com/jweelee/aweeclaw/issues)  提交
...
AweeClaw 在主流 AI 编辑器的基础上，实现了多项创新功能：
...
AweeClaw 的品牌资源统一收纳在 `public/brand/`，README 首屏、欢迎页、应用图标与 IP 形象都从这里引用，后续替换素材时不需要在多个目录里来回找。

<div align="center">
  <table>
    <tr>
      <td align="center" width="33%">
        <img src="public/brand/logos/app.png" alt="AweeClaw 深色 Logo" width="120" />
        <br />
        <strong>深色 Logo</strong>
      </td>
      <td align="center" width="33%">
        <img src="public/brand/logos/app-light.png" alt="AweeClaw 浅色 Logo" width="120" />
        <br />
        <strong>浅色 Logo</strong>
      </td>
      <td align="center" width="33%">
        <img src="public/brand/icons/sizes/app/128.png" alt="AweeClaw 应用图标" width="96" />
        <br />
        <strong>应用图标</strong>
      </td>
    </tr>
...
<div align="center">
  <img src="public/brand/ip/1.png" alt="AweeClaw IP 形象 1" width="120" />
  <img src="public/brand/ip/2.png" alt="AweeClaw IP 形象 2" width="120" />
  <img src="public/brand/ip/3.png" alt="AweeClaw IP 形象 3" width="120" />
  <img src="public/brand/ip/4.png" alt="AweeClaw IP 形象 4" width="120" />
  <img src="public/brand/ip/5.png" alt="AweeClaw IP 形象 5" width="120" />
  <img src="public/brand/ip/6.png" alt="AweeClaw IP 形象 6" width="120" />
</div>
...
<a href="https://www.star-history.com/#awee-worker/aweeclaw&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=awee-worker/aweeclaw&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=awee-worker/aweeclaw&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=awee-worker/aweeclaw&type=date&legend=top-left" />
 </picture>
</a>

## 👥 贡献者 | Contributors

感谢所有为 AweeClaw 做出贡献的开发者！你们是最棒的 🎉
...
**📧 授权申请**
- 商业授权请联系：awee.worker@gmail.com
- 团队使用授权请联系：awee.worker@gmail.com
