<div align="center">
  ...
  <img src="public/brand/logos/app.png" alt="AweeClaw Logo" width="156" />
</picture>
  ...
  <p>
    <a href="https://deepwiki.com/awee-worker/AweeClaw"><img src="https://deepwiki.com/badge.svg" alt="Ask DeepWiki" /></a>
...
AweeClaw is more than just an editor—it's your **intelligent programming companion**. It replicates and surpasses traditional IDE experiences, blending Cyberpunk glassmorphism design with a powerful built-in AI Agent that supports full-process automation from code generation to file operations.

<!-- Main Interface Demo -->
<div align="center">
  <img src="images/main.gif" alt="AweeClaw Main Interface Demo" width="820" />
</div>
...
> "Behind every line of code in AweeClaw, there's a spark of energy from our community!" ⚡️

A huge thank you to our generous supporters. Your coffee, milk tea, and energy drinks are what keep AweeClaw evolving!
...
Join our community to discuss AweeClaw usage and development!
...
| Scan to join WeChat group | QQ Group: `1076926858` | WeChat ID: `awee_worker` |

> 💡 For issues or suggestions, submit them on [Gitee Issues](https://gitee.com/jweelee/aweeclaw.git/issues) or [Github Issues](https://github.com/jweelee/aweeclaw/issues)
...
- **Multi-Theme Support**: 4 carefully designed built-in themes
  - `AweeClaw Dark` - Default dark theme, soft and eye-friendly
...
AweeClaw builds upon mainstream AI editors with multiple innovative features:
...
```bash
# 1. Clone project
git clone https://gitee.com/jweelee/aweeclaw.git.git
cd aweeclaw
...
AweeClaw keeps its brand resources in `public/brand/`. The README hero, welcome screens, app icons, and assistant IP assets all reference this folder, so future brand replacements stay in one predictable place.

<div align="center">
  <table>
    <tr>
      <td align="center" width="33%">
        <img src="public/brand/logos/app.png" alt="AweeClaw dark logo" width="120" />
        <br />
        <strong>Dark Logo</strong>
      </td>
      <td align="center" width="33%">
        <img src="public/brand/logos/app-light.png" alt="AweeClaw light logo" width="120" />
        <br />
        <strong>Light Logo</strong>
      </td>
      <td align="center" width="33%">
        <img src="public/brand/icons/sizes/app/128.png" alt="AweeClaw app icon" width="96" />
        <br />
...
<div align="center">
  <img src="public/brand/ip/1.png" alt="AweeClaw IP asset 1" width="120" />
  <img src="public/brand/ip/2.png" alt="AweeClaw IP asset 2" width="120" />
  <img src="public/brand/ip/3.png" alt="AweeClaw IP asset 3" width="120" />
  <img src="public/brand/ip/4.png" alt="AweeClaw IP asset 4" width="120" />
  <img src="public/brand/ip/5.png" alt="AweeClaw IP asset 5" width="120" />
  <img src="public/brand/ip/6.png" alt="AweeClaw IP asset 6" width="120" />
</div>
...
Many thanks to all the developers who have contributed to AweeClaw! You guys are the best 🎉

<a href="https://github.com/awee-worker"><img src="https://github.com/awee-worker.png" width="50" height="50" style="border-radius:50%" alt="awee"/></a>
...
If AweeClaw helps you, feel free to buy the author a coffee ☕️
...
- Commercial licensing contact: awee.worker@gmail.com
- Team usage authorization contact: awee.worker@gmail.com
