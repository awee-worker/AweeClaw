...
### ✨ 新功能
- 🌐 **远程 SSH 终端集成** (awee, joanboss)
  - 内置原生 SSH 客户端支持，可直接在 AweeClaw 中管理远程服务器文件、重启服务及执行命令。
- 🖥️ **Agent 专属终端复用** (awee)
...
- 🔍 **MCP 原生搜索** (awee)
  - 支持直接在 AweeClaw 内部搜索官方维护的 MCP 插件生态，一键安装。
...
- 💾 **自动保存索引** - 增量更新后自动保存到 `.aweeclaw/structural-index.json`
...
> 🎊 感谢使用 AweeClaw！有问题欢迎提 Issue，有想法欢迎 PR！
