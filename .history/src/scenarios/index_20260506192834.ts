 ...
 * 场景加载器负责动态注册和激活。
 *
 * 使用 import.meta.glob 动态发现 src/scenarios/*/index.ts 中的场景模块，
 * 新增场景只需在 src/scenarios/ 下创建目录，无需修改此文件。
 *
 * 架构层次：
...
const scenarioModuleEntries = import.meta.glob<{ default: ScenarioModule }>(
