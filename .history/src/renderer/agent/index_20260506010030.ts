...
export { knowledgeExtractor } from './services/knowledgeService/extractor'
export type { KnowledgeEntry, KnowledgeCategory, KnowledgeSource, KnowledgeSearchParams, KnowledgeSearchResult, KnowledgeEntryInput } from './services/knowledgeService/types'
export { longTermMemoryService } from './services/longTermMemoryService'
export type { MemoryEntry, MemorySource, MemoryStatus, MemorySearchParams, MemorySearchResult, DreamingConfig } from './services/longTermMemoryService/types'
