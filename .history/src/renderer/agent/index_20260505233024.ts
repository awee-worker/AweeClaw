...
export type { KnowledgeEntry, KnowledgeCategory, KnowledgeLayer, KnowledgeSearchParams, KnowledgeSearchResult, KnowledgeEntryInput } from './services/knowledgeService/types'
