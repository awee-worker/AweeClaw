    ...
    <div className="w-[60px] bg-background-secondary/80 backdrop-blur-xl border-r border-border/30 shadow-[1px_0_15px_rgba(0,0,0,0.03)] flex flex-col z-30 select-none items-center py-4">
      ...
      <div className="flex flex-col w-full items-center gap-3 pb-2">
        <Tooltip content={language === 'zh' ? '工作流' : 'Workflow'} side="right">
          ...
          >
            <LayoutGrid className="w-[22px] h-[22px] opacity-70 group-hover:opacity-100 group-hover:text-accent transition-all group-hover:drop-shadow-[0_0_8px_rgba(var(--accent)/0.4)] group-hover:scale-105" strokeWidth={1.5} />
          </button>
        </Tooltip>
