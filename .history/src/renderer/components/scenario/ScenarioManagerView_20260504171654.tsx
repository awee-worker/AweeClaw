...
export function ScenarioManagerView() {
    ...
    const handleInstallScenario = useCallback(() => {
        // TODO: Open install dialog / marketplace view
    }, [])
