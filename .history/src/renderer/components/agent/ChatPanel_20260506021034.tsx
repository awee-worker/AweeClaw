...
import { knowledgeExtractor } from '@/renderer/agent/services/knowledgeService/extractor'
...
import { playNotificationSound } from '@renderer/utils/notificationSound'
import {
...
export default function ChatPanel() {
  ...
  const renderTimelineItem = useCallback((item: ChatTimelineItem<RenderableMessageItem>) => {
    ...
    return (
      <div className={isChatPrimary ? 'max-w-[840px] mx-auto w-full' : ''}>
        <ChatMessageUI
          key={msg.id}
          message={msg}
