    ...
    >
      <div className="flex flex-col h-full">
        ...
        <div className="flex-1 min-h-0 relative z-0 flex flex-col pt-12">
          ...
          {/* Message List */}
          <div className={`flex-1 relative overflow-hidden flex flex-col min-h-0 ${isChatPrimary ? 'max-w-[800px] mx-auto w-full' : ''}`}>
            {/* 过渡用的骨架屏 */}
            <AnimatePresence>
          ...
          <div className={`shrink-0 z-20 flex flex-col ${isChatPrimary ? 'max-w-[800px] mx-auto w-full' : ''}`}>
