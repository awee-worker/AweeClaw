...
export function AppearanceSettings({ settings, setSettings, advancedConfig, setAdvancedConfig, language }: EditorSettingsProps) {
    ...
    const handleThemeChange = (themeId: string) => {
        ...
        window.electronAPI?.settings?.set?.('themeId', themeId)
    }
