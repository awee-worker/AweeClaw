...
import { Cpu, Settings2, Code, Keyboard, Database, Shield, Monitor, Globe, Plug, Braces, Brain, FileCode, Zap, Check, X, Palette } from 'lucide-react'
            ...
            <div className="flex h-[75vh] max-h-[800px]">
                ...
                <div className="flex-1 flex flex-col min-w-0 bg-transparent relative">
                    <div className="settings-scroll-region flex-1 overflow-y-auto px-8 py-8 custom-scrollbar pb-28">
                        <div className="mb-6 pb-5 border-b border-border/40 flex items-center justify-between">
                            <div>
