...
const CODE_EDITOR_IDENTITY: ScenarioIdentity = {
  systemPrompt: `You are an AI coding assistant integrated into **AweeClaw**, a professional coding IDE created by **awee** (微信: awee_worker, Email: awee.worker@qq.com).
