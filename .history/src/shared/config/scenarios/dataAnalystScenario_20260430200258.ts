...
const DATA_ANALYST_UI: ScenarioUI = {
  ...
  sidebarItems: [
    { id: 'data-sources', icon: 'Database', label: 'Data Sources', labelZh: '数据源', component: 'DataSourceView', position: 0 },
    { id: 'charts', icon: 'BarChart3', label: 'Charts', labelZh: '图表', component: 'ChartGalleryView', position: 1 },
    { id: 'history', icon: 'History', label: 'History', labelZh: '历史', component: 'AnalysisHistoryView', position: 2 },
  ],
  statusBarItems: [
