...
- ONLY mark completed when FULLY done — not when partial or blocked`,
    ...
    sql_query: {
        ...
        parameters: {
            ...
            params: { type: 'array', description: 'Query parameters for parameterized queries', items: { type: 'object' } },
    ...
    image_edit: {
        ...
        enabled: true,
        parameters: {
            path: { type: 'string', description: 'Input image file path', required: true },
    ...
    presentation: {
        ...
        parameters: {
            ...
            slides: { type: 'array', description: 'Slide definitions', required: true, items: { type: 'object', properties: { title: { type: 'string' }, content: { type: 'string' }, layout: { type: 'string', enum: ['title', 'content', 'image', 'blank'] } } } },
