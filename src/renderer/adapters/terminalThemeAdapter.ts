...
.xterm { font-feature-settings: "liga" 0; position: relative; user-select: none; -ms-user-select: none; -webkit-user-select: none; padding: 8px 10px; text-align: left; }
...
.xterm .xterm-screen { position: relative; text-align: left; }
