...
import { shellService } from '../services/terminalRuntime'
import { TerminalManagerDialog } from './TerminalManagerDialog'
import type { AvailableShell, ShellLink, ShellPreset } from '../types/terminalTypes'
...
export const TerminalLauncher = memo(ShellMenuComponent)
