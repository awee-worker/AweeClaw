...
export type SidePanel = 'explorer' | 'search' | 'git' | 'problems' | 'outline' | 'history' | 'extensions' | 'shell' | 'data-sources' | 'charts' | 'characters' | 'scenarios' | 'notes' | 'knowledge' | 'prompts' | 'tasks' | 'bookmarks' | 'stores' | 'diagnosis' | 'plans' | 'benchmarks' | 'schedule' | null
