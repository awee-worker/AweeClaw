...
import type { HandoffDocument } from '@intelligence/providerTypes'
...
export type AgentEvent =
  ...
  | { type: 'plan:complete'; planId: string; stats: import('../planner/providerTypes').ExecutionStats; sessionId?: string }
