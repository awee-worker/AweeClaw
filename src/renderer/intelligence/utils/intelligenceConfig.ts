 ...
 * 集中管理 Agent 运行时配置
 * 
 * 使用 src/shared/config@configuration/agentConfig.ts 作为配置源
 */

import { useStore } from '@store'
import { DEFAULT_AGENT_CONFIG, type AgentRuntimeConfig } from '@configuration/agentProfile'
import { getReadOnlyTools } from '@configuration/toolDefinitions'
