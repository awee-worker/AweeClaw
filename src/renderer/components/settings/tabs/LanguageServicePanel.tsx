...
export function LanguageServicePanel({ language }: LspSettingsProps) {
    ...
    <div className="space-y-8">
        ...
        <div className="space-y-3 p-4 bg-surface/30 rounded-lg border border-border">
          ...
          <div className="space-y-1">
            ...
            <div className="flex gap-2">
              ...
              />
              <ActionButton variant="secondary" size="sm" onClick={handleBrowse}>
      ...
      <section className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <ActionButton variant="ghost" size="sm" onClick={loadStatus} disabled={loading}>
