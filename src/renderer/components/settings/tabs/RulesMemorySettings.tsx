 ...
 * Rules & Memory 设置组件
 * 
 * 项目规则：.aweeclaw/rules.md - 静态规则文件
 * 项目记忆：.aweeclaw/memory.json - 动态记忆列表
 */
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <section className="p-5 bg-surface/30 rounded-xl border border-border space-y-4">
          ...
          <p className="text-xs text-text-muted">
            {t(
              '定义项目级 AI 行为规则，支持 .aweeclaw/rules.md、.cursorrules 等格式',
              'Define project-level AI behavior rules. Supports .aweeclaw/rules.md, .cursorrules, etc.'
            )}
          </p>
