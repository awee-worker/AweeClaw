...
export type SettingsTab = 'language' | 'provider' | 'appearance' | 'editor' | 'snippets' | 'agent' | 'rules' | 'memory' | 'skills' | 'mcp' | 'channel' | 'lsp' | 'keybindings' | 'indexing' | 'security' | 'system' | 'cloud'
