...
export type FileType = 'text' | 'markdown' | 'image' | 'html' | 'pdf' | 'docx' | 'doc' | 'pptx' | 'ppt' | 'xlsx' | 'csv' | 'binary' | 'unknown'
...
export function isPreviewableFile(path: string): boolean {
    ...
    return type === 'markdown' || type === 'image' || type === 'pdf' || type === 'docx' || type === 'doc' || type === 'pptx' || type === 'ppt' || type === 'xlsx' || type === 'csv'
}
