...
function ImageContent({ item }: { item: ToolRichContent }) {
  ...
  return (
    <>
      <ContentCard
        title={item.title || t('rich.imagePreview', useStore.getState().language as any)}
        icon={ImageIcon}
        noPadding
        actions={
          <>
...
function CodeContent({ item, maxHeight }: { item: ToolRichContent; maxHeight: string }) {
  ...
  return (
    <ContentCard
      title={item.language || t('rich.sourceCode', useStore.getState().language as any)}
      icon={Code}
      noPadding
      actions={
...
function JsonContent({ item, maxHeight }: { item: ToolRichContent; maxHeight: string }) {
  return (
    <ContentCard title={t('rich.jsonData', useStore.getState().language as any)} icon={Code} noPadding>
...
function HtmlContent({ item, maxHeight }: { item: ToolRichContent; maxHeight: string }) {
  return (
    <ContentCard title={t('rich.htmlPreview', useStore.getState().language as any)} icon={Code} noPadding>
      <SafeHTML
        html={item.text}
