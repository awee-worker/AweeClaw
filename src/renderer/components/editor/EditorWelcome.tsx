...
function WelcomeWorkbench({
  ...
  return (
    <div className="aweeclaw-editor-welcome h-full overflow-hidden bg-background text-text-primary">
      <WelcomeStyles rootClass="aweeclaw-editor-welcome" />
          ...
          <div className="aweeclaw-welcome-card">
            <div className="aweeclaw-welcome-main">
              <div className="aweeclaw-welcome-copy">
                <p className="aweeclaw-welcome-eyebrow">{eyebrow}</p>
                <h2 className="aweeclaw-welcome-title">{title}</h2>
                <p className="aweeclaw-welcome-subtitle">{subtitle}</p>
            ...
            <div className="aweeclaw-welcome-bottom-row">
              <div className="aweeclaw-welcome-footer-actions">{footer}</div>

              <div className="aweeclaw-welcome-shortcuts">
...
function WelcomeStyles({ rootClass }: { rootClass: string }) {
  return (
    <style>{`
      ...
      .${rootClass} .aweeclaw-welcome-bottom-row {
        display: flex;
        flex-wrap: wrap;
        align-items: center;
        justify-content: space-between;
