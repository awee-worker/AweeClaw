...
import { getFileName, getDirname, getBasename } from '@shared/toolkit/pathHelper'
...
export default function ProjectSelector() {
    ...
    const loadRecent = async () => {
        try {
            ...
            logger.ui.error('[ProjectSelector] Failed to load recent workspaces:', e)
        }
    }
    ...
    const handleOpenRecent = async (path: string) => {
        ...
        try {
            ...
            logger.ui.error('[ProjectSelector] Failed to open recent workspace:', e)
