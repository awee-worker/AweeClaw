...
export type OpenAICompatibilityProfile = import('@shared/configuration/aiProviders').OpenAICompatibilityProfile
...
export interface LLMConfig {
    ...
    protocol?: import('@shared/configuration/aiProviders').ApiProtocol
...
export interface ToolExecutionContext {
    ...
    chatMode?: import('@renderer/modes/workModeTypes').WorkMode
    toolCallId?: string
