...
export const MCP_PRESETS: McpPreset[] = [
  ...
  },
  {
    ...
    envConfig: [
      { key: 'MYSQL_HOST', label: 'Host', labelZh: '主机', required: true, secret: false, placeholder: '127.0.0.1' },
      ...
      { key: 'MYSQL_PASS', label: 'Password', labelZh: '密码', required: true, secret: true },
      { key: 'MYSQL_DB', label: 'Database', labelZh: '数据库名', required: true, secret: false },
    ],
    defaultAutoApprove: ['mysql_query', 'query', 'list_tables', 'describe_table'],
    requiresConfig: true,
  ...
  // ===== 项目管理 =====
  {
    ...
    envConfig: [
      ...
      { key: 'JIRA_API_TOKEN', label: 'API Token', labelZh: 'API 令牌', description: 'Create at https://id.atlassian.com/manage-profile/api-tokens', descriptionZh: '在 https://id.atlassian.com/manage-profile/api-tokens 创建', required: true, secret: true },
    ],
    defaultAutoApprove: ['list_issues', 'get_issue', 'search_issues'],
    requiresConfig: true,
