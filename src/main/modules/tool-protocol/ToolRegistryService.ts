...
export class McpRegistryService {
     ...
     */
    toLocalConfig(server: RegistryServer): import('@shared/protocols/toolProtocolBridge').McpServerConfig | null {
        // 优先使用 npm stdio 包
        ...
        if (npmPackage) {
            ...
            } as import('@shared/protocols/toolProtocolBridge').McpServerConfig
        }
