...
const TOOL_RISK_MAP: Record<string, ToolRiskLevel> = {
  ...
  get_definition: 'safe',
  go_to_definition: 'safe',
  get_hover_info: 'safe',
  get_lint_errors: 'safe',
  web_search: 'safe',
  read_url: 'safe',
  read_terminal_output: 'safe',
  ...
  send_terminal_input: 'moderate',
  stop_terminal: 'moderate',
  git_commit: 'moderate',
  git_diff: 'safe',
  git_log: 'safe',
  sql_query: 'moderate',
  data_transform: 'moderate',
  csv_analyze: 'safe',
  chart_generate: 'moderate',
  statistical_test: 'safe',
  doc_write: 'moderate',
  spreadsheet: 'moderate',
  presentation: 'moderate',
  image_generate: 'moderate',
  image_edit: 'moderate',
  audio_transcribe: 'safe',
  video_analyze: 'safe',
